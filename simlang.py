...
def runCode(code):
	...
	try:
		if m == "log":
			...
			with open(o[0], "wb", encoding="utf-8") as f:
				f.write(";".join(o[1:]).encode())
		elif m == "file.writebinf":
			with open(fstring(o[0]), "wb", encoding="utf-8") as f:
			...
			with open(o[0], "rb", encoding="utf-8") as f:
				vars[o[1]] = f.read()
		elif m == "file.readbinf":
			with open(fstring(o[0]), "rb", encoding="utf-8") as f:
				vars[fstring(o[1])] = fstring(f.read())
		elif m == "file.delete":
			name = fstring(o[0])
