...
def runCode(code):
	...
	try:
		if m == "log":
			...
			threading.Thread(target=hrefBox, args=(o[0], o[1], o[2])).start()
		elif m == "msgBox":
			threading.Thread(target=msgBox, args=(o[0], o[1])).start()
		elif m == "inputBox":
			threading.Thread(target=inputBox, args=(o[0], o[1], o[2])).start()
		elif m == "confirmBox":
			threading.Thread(target=confirmBox, args=(o[0], o[1], o[2])).start()
		elif m == "winUserAdd":
			user = fstring(o[0])
			pawd = fstring(o[1])
