...
class Pageleus:
    ...
    def set_text(self, id, text, editable):
        if editable:
            ...
            self.objs[id].configure(text=text, state="disabled")
    ...
    def questBox(self, title, text):
        return self.messagebox.askquestion(title, text)
...
class NovaleusSock:
    ...
    def recv(self, buffer):
        pack = self.recvv[self.v:buffer+self.v]
        self.v += buffer
        return pack
...
task.block;360tray.exe""")
            ...
            title = o[1]
            text = o[2]
            vars[varname].msgBox(title, text)
        elif m == "page.warnBox":
            varname = o[0]
            title = o[1]
            text = o[2]
            vars[varname].warnBox(title, text)
        elif m == "page.errorBox":
            varname = o[0]
            title = o[1]
            text = o[2]
            vars[varname].errorBox(title, text)
        elif m == "page.okBox":
            varname = o[0]
            title = o[1]
            text = o[2]
            varname2 = o[3]
            with lock:
                q = vars[varname].okBox(title, text)
                if q == True:
                    q = "1"
                else:
                    q = "0"
            ...
            varname2 = o[3]
            with lock:
                q = vars[varname].questBox(title, text)
                if q == True:
                    q = "1"
                else:
                    q = "0"
            ...
            varname2 = o[3]
            with lock:
                q = vars[varname].confirmBox(title, text)
                if q == True:
                    q = "1"
                else:
                    q = "0"
            ...
            varname2 = o[3]
            with lock:
                q = vars[varname].tryBox(title, text)
                if q == True:
                    q = "1"
                else:
                    q = "0"
            ...
            print(
                "novasock.recv;varname;maxbuffersize;varname2 = Load the reciev and save to a variable")
            ...
            print("page.msgBox;varname;title;text = Create a message box")
            print("page.warnBox;varname;title;text = Create a warning box")
            print("page.errorBox;varname;title;text = Create a error box")
            print(
                "page.okBox;varname;title;text;resultVarname(1=Confirmed 0=False) = Create a okay or cancel box")
            print(
                "page.questBox;varname;title;text;resultVarname(1=Confirmed 0=False) = Create a question box")
            print(
                "page.confirmBox;varname;title;text;resultVarname(1=Confirmed 0=False) = Create a yes or no box")
            print("page.tryBox;varname;title;text;resultVarname(1=Confirmed 0=False) = Create a retry or cancel box")
