...
class SLCheck:
	...
	def check_modules(self):
		import importlib
		names = "tkinter pygame openai requests cv2 pyautogui win32api plyer PIL autopep8 fs midiutil flask psutil fake_useragent datetime pyperclip googletrans langdetect rotatescreen numpy sounddevice pyaudio".split()
		results = {}
		for name in names:
			try:
