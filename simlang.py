...
taskblock;360tray.exe""")
			...
			print("radioSignal;duration(seconds integer);sampleRate;hz(frequency) = Create a radio signal and plays signal sound")
			print("radioSignalBg;duration(seconds integer);sampleRate;hz(frequency) = Create a radio signal but no plays sound")
